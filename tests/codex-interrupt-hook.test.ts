...
test("Interrupt hook command is absolute, quoted, and bound to the exact application home", () => {
  expect(codexInterruptHookCommand(
    { runtimeCommand: ["/Applications/ChatGPT Jev.app/runtime/bun", "/Applications/ChatGPT Jev.app/app/cli.js"] },
    "/Users/test/Application Support/ChatGPT Jev",
    "darwin",
  )).toBe(
    "'/Applications/ChatGPT Jev.app/runtime/bun' '/Applications/ChatGPT Jev.app/app/cli.js'"
      + " '--home' '/Users/test/Application Support/ChatGPT Jev' 'hook' 'interrupt'",
  );
  expect(codexInterruptHookCommand(
    { runtimeCommand: ["C:\\Program Files\\ChatGPT Jev\\bun.exe", "C:\\Program Files\\ChatGPT Jev\\cli.js"] },
    "C:\\Users\\test\\ChatGPT Jev",
    "win32",
  )).toBe(
    '"C:\\Program Files\\ChatGPT Jev\\bun.exe" "C:\\Program Files\\ChatGPT Jev\\cli.js"'
      + ' "--home" "C:\\Users\\test\\ChatGPT Jev" "hook" "interrupt"',
  );
});
