...
function schedulePersist(): void {
  ...
  // Resolve the target path now: tests may swap CHATGPT_JEV_HOME before the
...
export function flushResponseState(): void {
  if (!persistTimer) return;
  // Use the path captured when the write was scheduled; CHATGPT_JEV_HOME may have moved.
