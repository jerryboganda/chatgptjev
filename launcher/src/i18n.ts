...
const en = {
  ...
  jevJudgmentsBody: "Required",
  jevKeyMissing: "Required. AI_GATEWAY_API_KEY is missing.",
  ...
  autoUpdateBody: "Install new versions of ChatGPT Jev automatically when they are published. The app restarts itself to finish an update; turns in progress are never interrupted.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  jevJudgmentsBody: "必需",
  jevKeyMissing: "必需。未设置 AI_GATEWAY_API_KEY。",
  ...
  settings: "设置项",
  autoUpdate: "自动更新",
  autoUpdateBody: "发布新版本时自动安装。更新需重启应用；正在进行的对话不会被中断。",
  updateAvailable: "更新至",
  updating: "正在更新…",
  workspace: "工作区",
  configuration: "配置",
...
const ja: Record<keyof typeof en, string> = {
  ...
  jevJudgmentsBody: "必須",
  jevKeyMissing: "必須。AI_GATEWAY_API_KEY が未設定です。",
  ...
  settings: "設定",
  autoUpdate: "自動アップデート",
  autoUpdateBody: "新しいバージョンが公開されたら自動的にインストールします。更新にはアプリの再起動が必要です。実行中のターンは中断されません。",
...
const ko: Record<keyof typeof en, string> = {
  ...
  jevJudgmentsBody: "필수",
  jevKeyMissing: "필수. AI_GATEWAY_API_KEY가 설정되지 않았습니다.",
  ...
  settings: "설정",
  autoUpdate: "자동 업데이트",
  autoUpdateBody: "새 버전이 게시되면 자동으로 설치합니다. 업데이트 시 앱이 다시 시작되며 진행 중인 턴은 중단되지 않습니다.",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  jevJudgmentsBody: "必要",
  jevKeyMissing: "必要。未設定 AI_GATEWAY_API_KEY。",
  ...
  settings: "設定項目",
  autoUpdate: "自動更新",
  autoUpdateBody: "發布新版本時自動安裝。更新需重新啟動應用程式；進行中的對話不會被中斷。",
  updateAvailable: "更新至",
  updating: "正在更新…",
  workspace: "工作區",
  configuration: "組態",
