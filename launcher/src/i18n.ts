...
const en = {
  ...
  devConnectorIsolationNotice: "Create a separate connector with the exact DEV name below. Keep Codex Jev unchanged so production and repository development can run side by side.",
  ...
  jevJudgments: "AI judgments (Jev)",
  jevJudgmentsBody: "Lets TypeSafe Jev read ChatGPT dialogs, stalls, tool requests, answers, and failures and pick the safest response in every mode, including Zero Risk. Built-in rules stay as the fallback. Changing it restarts the runtime. On by default.",
  jevKeyMissing: "AI_GATEWAY_API_KEY is not set for this Windows account, so judgments fall back to the built-in rules. Add it in Environment Variables, then restart ChatGPT Jev.",
  ...
  supportBody: "Star the repository and open my X profile to help more developers find ChatGPT Jev. I share product updates and useful Codex tips on X.",
  star: "Star on GitHub",
  ...
  zeroRiskDefaultProfileBody: "Install only ChatGPT Jev — Zero Risk.",
  zeroRiskProProfile: "Pro",
  zeroRiskProProfileBody: "Also install ChatGPT Jev — Zero Risk Pro.",
  ...
  manualMcpStepThreeBody: "Create the separate connector shown below with the exact name Codex Jev Zero Risk and select it yourself in every Zero Risk turn. Zero Risk requires its own tunnel and credentials, separate from Automatic mode. The launcher never inspects the ChatGPT DOM in this mode.",
  connectorMigrationNotice: "Upgrading from Codex Native? Leave the old connector untouched and create Codex Jev as a new connector. Do not rename or refresh Codex Native. Verify runtime rejects a legacy-only setup.",
  manualConnectorNotice: "Codex Jev Zero Risk is a separate connector. Select it yourself before sending every Zero Risk prompt; the launcher intentionally does not inspect ChatGPT to verify that choice.",
  ...
  manualPromptInstruction: "The prompt is already in your clipboard. Paste it into the open ChatGPT tab, choose the model and effort you want, select the Codex Jev Zero Risk connector, send it, then confirm below.",
  manualPromptCopy: "Copy prompt",
  manualPromptCancel: "Cancel turn",
  manualPromptSent: "Sent",
  manualPromptWaiting: "Waiting for Codex Jev Zero Risk to connect",
...
const zh: Record<keyof typeof en, string> = {
  ...
  devConnectorIsolationNotice: "请使用下方准确的 DEV 名称新建独立连接器。保留 Codex Jev 不变，让生产使用和仓库开发可以同时运行。",
  ...
  jevJudgments: "AI 判断（Jev）",
  jevJudgmentsBody: "让 TypeSafe Jev 读取 ChatGPT 的对话框、停滞、工具请求、回答和故障，并在包括 Zero Risk 的所有模式下选择最安全的处理方式。内置规则仍作为后备。更改后会重启运行时。默认开启。",
  jevKeyMissing: "当前 Windows 账户未设置 AI_GATEWAY_API_KEY，判断将回退到内置规则。请在环境变量中添加后重启 ChatGPT Jev。",
  ...
  continue: "继续",
  supportTitle: "开始之前",
  supportBody: "请为仓库 Star，并打开我的 X 主页，帮助更多开发者发现 ChatGPT Jev。我会在 X 分享产品更新和实用的 Codex 技巧。",
  ...
  zeroRiskDefaultProfileBody: "仅安装 ChatGPT Jev — Zero Risk。",
  zeroRiskProProfile: "Pro",
  zeroRiskProProfileBody: "同时安装 ChatGPT Jev — Zero Risk Pro。",
  ...
  manualMcpStepThreeBody: "请使用下方显示的准确名称 Codex Jev Zero Risk 创建独立连接器，并在每次引导式手动回合中自行选择它。Zero Risk 必须使用与自动模式分开的 Tunnel 和凭据。此模式不会执行 DOM 检查。",
  connectorMigrationNotice: "从 Codex Native 升级？请保留旧连接器不变，并新建名为 Codex Jev 的连接器。不要重命名或刷新 Codex Native。仅有旧连接器时，运行时验证会明确失败。",
  manualConnectorNotice: "Codex Jev Zero Risk 是独立连接器。每次发送引导式提示前都需要自行选择它；启动器有意不检查 ChatGPT DOM 来验证该选择。",
  ...
  manualPromptInstruction: "提示已复制到剪贴板。请将其粘贴到打开的 ChatGPT 标签页，选择所需模型和 effort，再选择 Codex Jev Zero Risk 连接器，发送后在下方确认。",
  manualPromptCopy: "复制提示",
  manualPromptCancel: "取消任务",
  manualPromptSent: "已发送",
  manualPromptWaiting: "等待 Codex Jev Zero Risk 连接",
...
const ja: Record<keyof typeof en, string> = {
  ...
  devConnectorIsolationNotice: "下記の正確な DEV 名で個別のコネクタを作成してください。Codex Jev は変更せず、本番利用とリポジトリ開発を並行して実行できる状態を保ちます。",
  ...
  jevJudgments: "AI 判定（Jev）",
  jevJudgmentsBody: "TypeSafe Jev が ChatGPT のダイアログ、停止、ツール要求、回答、障害を読み取り、Zero Risk を含むすべてのモードで最も安全な対応を選びます。内蔵ルールは引き続きフォールバックとして残ります。変更するとランタイムが再起動します。既定でオン。",
  jevKeyMissing: "この Windows アカウントには AI_GATEWAY_API_KEY が設定されていないため、判定は内蔵ルールにフォールバックします。環境変数に追加してから ChatGPT Jev を再起動してください。",
  ...
  continue: "続ける",
  supportTitle: "開始する前に",
  supportBody: "より多くの開発者に ChatGPT Jev を知ってもらうため、リポジトリに Star を付け、私の X プロフィールを開いてください。X では製品のアップデートや便利な Codex の使い方を紹介しています。",
  star: "GitHub で Star",
  ...
  setupTitle: "ChatGPT Jev をセットアップ",
  ...
  zeroRiskDefaultProfileBody: "ChatGPT Jev — Zero Risk のみをインストールします。",
  zeroRiskProProfile: "Pro",
  zeroRiskProProfileBody: "ChatGPT Jev — Zero Risk Pro もインストールします。",
  ...
  manualMcpStepThreeBody: "下に表示される正確な名前 Codex Jev Zero Risk で専用コネクタを作成し、ガイド付き手動ターンごとに自分で選択してください。Zero Risk では、自動モードとは別の Tunnel と認証情報が必要です。このモードでは DOM 検査を行いません。",
  connectorMigrationNotice: "Codex Native からアップグレードする場合は、古いコネクタを変更せず、新しい Codex Jev コネクタを作成してください。Codex Native の名前変更や更新は行わないでください。古いコネクタしかない場合、ランタイム検証は明示的に失敗します。",
  manualConnectorNotice: "Codex Jev Zero Risk は専用コネクタです。ガイド付きプロンプトを送信する前に毎回自分で選択してください。ランチャーはその選択を確認するための ChatGPT DOM 検査を意図的に行いません。",
  ...
  manualPromptInstruction: "プロンプトはクリップボードにコピー済みです。開いている ChatGPT タブに貼り付け、モデルと effort、Codex Jev Zero Risk コネクタを選んで送信し、下で確認してください。",
  manualPromptCopy: "プロンプトをコピー",
  manualPromptCancel: "ターンをキャンセル",
  manualPromptSent: "送信済み",
  manualPromptWaiting: "Codex Jev Zero Risk の接続を待機中",
...
const ko: Record<keyof typeof en, string> = {
  ...
  devConnectorIsolationNotice: "아래의 정확한 DEV 이름으로 별도의 커넥터를 만드세요. Codex Jev는 변경하지 않아 프로덕션 환경과 저장소 개발 환경을 동시에 사용할 수 있도록 유지하세요.",
  ...
  jevJudgments: "AI 판단(Jev)",
  jevJudgmentsBody: "TypeSafe Jev가 ChatGPT의 대화 상자, 정지, 도구 요청, 답변, 오류를 읽고 Zero Risk를 포함한 모든 모드에서 가장 안전한 대응을 선택합니다. 내장 규칙은 대체 수단으로 유지됩니다. 변경하면 런타임이 다시 시작됩니다. 기본값은 켜짐입니다.",
  jevKeyMissing: "이 Windows 계정에 AI_GATEWAY_API_KEY가 설정되어 있지 않아 판단이 내장 규칙으로 대체됩니다. 환경 변수에 추가한 뒤 ChatGPT Jev를 다시 시작하세요.",
  ...
  supportBody: "더 많은 개발자가 ChatGPT Jev를 찾을 수 있도록 저장소에 Star를 누르고 제 X 프로필을 열어주세요. X에서 제품 업데이트와 유용한 Codex 활용 팁을 공유합니다.",
  star: "GitHub에서 Star",
  starred: "GitHub 열림",
  follow: "X 열기",
  followed: "X 열림",
  ...
  zeroRiskDefaultProfileBody: "ChatGPT Jev — Zero Risk만 설치합니다.",
  zeroRiskProProfile: "Pro",
  zeroRiskProProfileBody: "ChatGPT Jev — Zero Risk Pro도 함께 설치합니다.",
  ...
  manualMcpStepThreeBody: "아래에 표시된 정확한 이름인 Codex Jev Zero Risk로 별도의 커넥터를 만들고, 모든 Zero Risk 턴에서 직접 선택하세요. Zero Risk는 자동 모드와 별도의 터널 및 인증 정보가 필요합니다. 이 모드에서는 런처가 ChatGPT DOM을 검사하지 않습니다.",
  connectorMigrationNotice: "Codex Native에서 업그레이드하는 경우 기존 커넥터는 그대로 두고 Codex Jev라는 새 커넥터를 만드세요. Codex Native의 이름을 변경하거나 새로고침하지 마세요. 기존 커넥터만 있는 구성은 런타임 검증에서 거부됩니다.",
  manualConnectorNotice: "Codex Jev Zero Risk는 별도의 커넥터입니다. 각 Zero Risk 프롬프트를 보내기 전에 직접 선택하세요. 런처는 해당 선택을 확인하기 위해 ChatGPT DOM을 의도적으로 검사하지 않습니다.",
  ...
  manualPromptInstruction: "프롬프트가 이미 클립보드에 복사되어 있습니다. 열려 있는 ChatGPT 탭에 붙여넣고 원하는 모델과 effort를 선택한 다음 Codex Jev Zero Risk 커넥터를 선택하여 전송하고 아래에서 확인하세요.",
  manualPromptCopy: "프롬프트 복사",
  manualPromptCancel: "턴 취소",
  manualPromptSent: "전송됨",
  manualPromptWaiting: "Codex Jev Zero Risk 연결 대기 중",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  devConnectorIsolationNotice: "請使用下方正確的 DEV 名稱新增獨立連接器。保留 Codex Jev 不變，讓正式環境與儲存庫開發可以同時執行。",
  ...
  jevJudgments: "AI 判斷（Jev）",
  jevJudgmentsBody: "讓 TypeSafe Jev 讀取 ChatGPT 的對話框、停滯、工具請求、回答和故障，並在包括 Zero Risk 的所有模式下選擇最安全的處理方式。內建規則仍作為後備。變更後會重新啟動執行階段。預設開啟。",
  jevKeyMissing: "目前 Windows 帳戶未設定 AI_GATEWAY_API_KEY，判斷將回退到內建規則。請在環境變數中新增後重新啟動 ChatGPT Jev。",
  ...
  continue: "繼續",
  supportTitle: "開始之前",
  supportBody: "請為儲存庫按 Star，並開啟我的 X 主頁，幫助更多開發者發現 ChatGPT Jev。我會在 X 分享產品更新和實用的 Codex 技巧。",
  ...
  zeroRiskDefaultProfileBody: "只安裝 ChatGPT Jev — Zero Risk。",
  zeroRiskProProfile: "Pro",
  zeroRiskProProfileBody: "同時安裝 ChatGPT Jev — Zero Risk Pro。",
  ...
  manualMcpStepThreeBody: "請使用下方顯示的正確名稱 Codex Jev Zero Risk 建立獨立連接器，並在每次引導式手動回合中自行選擇它。Zero Risk 必須使用與自動模式分開的 Tunnel 與憑證。此模式不會執行 DOM 檢查。",
  connectorMigrationNotice: "從 Codex Native 升級？請保留舊連接器不變，並新增名為 Codex Jev 的連接器。不要重新命名或重新整理 Codex Native。僅有舊連接器時，執行階段驗證會明確失敗。",
  manualConnectorNotice: "Codex Jev Zero Risk 是獨立連接器。每次傳送引導式提示前都需要自行選擇它；啟動器有意不檢查 ChatGPT DOM 來驗證該選擇。",
  ...
  manualPromptInstruction: "提示已複製到剪貼簿。請將其貼到開啟的 ChatGPT 分頁，選擇所需模型與 effort，再選擇 Codex Jev Zero Risk 連接器，傳送後在下方確認。",
  manualPromptCopy: "複製提示",
  manualPromptCancel: "取消任務",
  manualPromptSent: "已傳送",
  manualPromptWaiting: "等待 Codex Jev Zero Risk 連線",
